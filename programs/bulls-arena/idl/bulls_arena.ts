...
export type BullsArena = {
  "address": "EpRY6fkv4RcazjYSJyk8rppeVTVMcWhCcVtTVrKkTLT4",
  "metadata": {
    "name": "bullsArena",
    "version": "0.1.0",
    "spec": "0.1.0",
  ...
  "errors": [
    ...
    },
    {
      ...
      "msg": "this round has not finished — its house take cannot be swept yet"
    },
    {
      "code": 6018,
      "name": "alreadySwept",
      "msg": "this round's house take has already been swept"
    },
    {
      "code": 6019,
      "name": "notTheAuthority",
      "msg": "only the arena's authority may close a lobby before its deadline"
    },
    {
      "code": 6020,
      "name": "roundNotSwept",
      "msg": "this round's house take has not been swept — sweep it before closing the account"
    },
    {
      "code": 6021,
      "name": "roundTooRecent",
